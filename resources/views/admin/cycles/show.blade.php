        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('admin.products.edit', $cycle) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                        Edit Product
                    </a>
            ...
            <div class="mt-8 flex justify-between">
                <form action="{{ route('admin.products.toggle-publish', $cycle) }}" method="POST" class="inline">
                    @csrf
                ...
                <form action="{{ route('admin.products.destroy', $cycle) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this product?')">
                    @csrf
                    @method('DELETE')
