                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.cycles.destroy', $cycle) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this cycle?')">
                                                        ...
                                                        <button type="submit" class="text-red-600 hover:text-red-900 text-sm">Delete</button>
                                                                                ...
                                                                                <a href="{{ route('admin.products.show', $cycle) }}" class="text-blue-600 hover:text-blue-900 text-sm">View</a>
                                                                                <a href="{{ route('admin.products.edit', $cycle) }}" class="text-indigo-600 hover:text-indigo-900 text-sm">Edit</a>
                                                                                <form method="POST" action="{{ route('admin.products.toggle-publish', $cycle) }}" class="inline">
                        @endforeach
                    </ul>
                @else
                    <div class="text-center py-12">
                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                                                                <form method="POST" action="{{ route('admin.products.destroy', $cycle) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this product?')">
