                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">{{ $product->brand }} • {{ $product->type }}</div>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div class="text-right">
                                                ...
                                                <div class="text-sm text-gray-500">{{ $product->stock_status }}</div>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $product->is_published ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                    {{ $product->is_published ? 'Published' : 'Draft' }}
                                                </span>
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('admin.products.show', $product) }}" class="text-blue-600 hover:text-blue-900 text-sm">View</a>
                                                    <a href="{{ route('admin.products.edit', $product) }}" class="text-indigo-600 hover:text-indigo-900 text-sm">Edit</a>
