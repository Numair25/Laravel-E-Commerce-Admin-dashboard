            ...
            <div class="flex">
                ...
                <div class="w-64 bg-white shadow-sm min-h-screen">
                    <nav class="mt-5 px-2">
                        ...
                        <a href="{{ route('admin.cycles.index') }}" class="mt-1 group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.cycles.*') ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
